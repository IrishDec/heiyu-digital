        ...
        <div className="bg-[#0f0f0f] rounded-3xl border border-white/10 overflow-hidden shadow-2xl">
          <div className="grid md:grid-cols-2 gap-0 min-h-[500px]">
            ...
            <div className="p-8 md:p-14 flex flex-col justify-center">
              ...
              <a href="https://heiyuquiz.com" target="_blank" className="text-white font-bold border-b border-purple-500 pb-1 self-start hover:text-purple-400 transition">Play Now →</a>
            </div>
          </div>
        </div>
      </section>
